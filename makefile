...
# Files
HDRS		:=
SRCS		:= E:/FPGA_MONITOR/LedsAndSwitches.c
OBJS		:= $(patsubst %, %.o, $(SRCS))

# Targets
COMPILE: LedsAndSwitches.srec

LedsAndSwitches.srec: LedsAndSwitches.axf
	$(RM) $@
	$(OC) $(OCFLAGS) $< $@

LedsAndSwitches.axf: $(OBJS)
	$(RM) $@
	$(CC) $(LDFLAGS) $(OBJS) -o $@
...
CLEAN: 
	$(RM) LedsAndSwitches.srec LedsAndSwitches.axf $(OBJS)

...
if ![info exists TOP_LEVEL_NAME] { 
  set TOP_LEVEL_NAME "CPEN391_Computer"
}
...
alias file_copy {
  echo "\[exec\] file_copy"
  file copy -force $QSYS_SIMDIR/submodules/CPEN391_Computer_Onchip_SRAM.hex ./
}
...
alias com {
  echo "\[exec\] com"
  eval  vlog -v2k5 $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/CPEN391_Computer_System_PLL.v"           -work System_PLL         
  eval  vlog -v2k5 $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/CPEN391_Computer_SysID.v"                -work SysID              
  eval  vlog -v2k5 $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/CPEN391_Computer_Slider_Switches.v"      -work Slider_Switches    
  eval  vlog -v2k5 $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/CPEN391_Computer_SDRAM.v"                -work SDRAM              
  eval  vlog -v2k5 $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/CPEN391_Computer_SDRAM_test_component.v" -work SDRAM              
  eval  vlog -v2k5 $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/CPEN391_Computer_PushButtons.v"          -work PushButtons        
  eval  vlog -v2k5 $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/CPEN391_Computer_Onchip_SRAM.v"          -work Onchip_SRAM        
  eval  vlog -v2k5 $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/CPEN391_Computer_LEDS.v"                 -work LEDS               
  eval  vlog -v2k5 $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/CPEN391_Computer_JTAG_UART_For_ARM0.v"   -work JTAG_UART_For_ARM0 
  eval  vlog -v2k5 $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/CPEN391_Computer_JTAG_To_FPGA_Bridge.v"  -work JTAG_To_FPGA_Bridge
  eval  vlog -v2k5 $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/CPEN391_Computer_Interval_Timer.v"       -work Interval_Timer     
  eval  vlog -v2k5 $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/CPEN391_Computer_HEX0_1.v"               -work HEX0_1             
  eval  vlog -v2k5 $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/CPEN391_Computer_ARM_A9_HPS.v"           -work ARM_A9_HPS         
  eval  vlog -v2k5 $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/CPEN391_Computer.v"                                                          
}
...
alias elab {
  echo "\[exec\] elab"
  eval vsim +access +r -t ps $ELAB_OPTIONS -L work -L System_PLL -L SysID -L Slider_Switches -L SDRAM -L PushButtons -L Onchip_SRAM -L LEDS -L JTAG_UART_For_ARM0 -L JTAG_To_FPGA_Bridge -L Interval_Timer -L HEX0_1 -L ARM_A9_HPS -L altera_ver -L lpm_ver -L sgate_ver -L altera_mf_ver -L altera_lnsim_ver -L cyclonev_ver -L cyclonev_hssi_ver -L cyclonev_pcie_hip_ver $TOP_LEVEL_NAME
}
...
alias elab_debug {
  ...
  eval vsim -dbg -O2 +access +r -t ps $ELAB_OPTIONS -L work -L System_PLL -L SysID -L Slider_Switches -L SDRAM -L PushButtons -L Onchip_SRAM -L LEDS -L JTAG_UART_For_ARM0 -L JTAG_To_FPGA_Bridge -L Interval_Timer -L HEX0_1 -L ARM_A9_HPS -L altera_ver -L lpm_ver -L sgate_ver -L altera_mf_ver -L altera_lnsim_ver -L cyclonev_ver -L cyclonev_hssi_ver -L cyclonev_pcie_hip_ver $TOP_LEVEL_NAME
}
